...
use Simpmelie\Utils\Transformers\Transformer;
use Simpmelie\Utils\Validation\Redemption;
...
class UtilsServiceProvider extends ServiceProvider
{
    ...
    protected function extendValidator()
    {
        ...
        // 兑换码格式校验
        Validator::extend('redeem_code', function ($attribute, $value, $parameters, $validator) {
            return Redemption::validateCode($value);
        });

        // 核销码格式校验
        Validator::extend('verify_code', function ($attribute, $value, $parameters, $validator) {
            return Redemption::validateVerifyCode($value);
        });
    }
}
